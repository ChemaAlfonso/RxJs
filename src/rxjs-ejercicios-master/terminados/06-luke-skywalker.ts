...
import { switchMap, map, pluck, mergeAll, tap, mergeMap } from 'rxjs/operators';
...
(() =>{
    ...
    // VERSION PROPIA
    // const luck$ = getRequest(`${ SW_API }/people/1` );
    // const raza$ = luck$.pipe( 
    //                     pluck('species'),
    //                     switchMap( ( req ) => getRequest(req) ) 
    // );
